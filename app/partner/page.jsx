...
export default function PartnerPage() {
  ...
  async function handleSubmit(e) {
    ...
    const res = await fetch("https://formspree.io/f/mpqlwlqe", {
      method: "POST",
          ...
          {!success ? (
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Input label="Company / Brand Name" name="company" />
                <Input label="Contact Person Name" name="person" />
            ...
            >
              <SuccessContent
                ...
                message="Thank you for your interest in collaborating with Omegastrike.
